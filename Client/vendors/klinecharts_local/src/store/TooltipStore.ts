...
export interface TooltipIndicator {
  paneId: string
  indicatorName: string
}
...
export default class TooltipStore {
  ...
  private _activeTooltipIndicator: Nullable<TooltipIndicator> = null
  ...
  setActiveTooltipIndicator (tooltipIndicator?: TooltipIndicator): void {
    this._activeTooltipIndicator = tooltipIndicator ?? null
  }

  getActiveTooltipIndicator (): Nullable<TooltipIndicator> {
    return this._activeTooltipIndicator
  }

  clear (): void {
    this.setCrosshair({}, { notInvalidate: true })
    this.setActiveIcon()
    this.setActiveTooltipIndicator()
  }
}
