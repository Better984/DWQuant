...
- `Client/src/components/strategy/StrategyWorkbench.tsx` + `Client/src/components/strategy/StrategyWorkbenchKline.tsx`：策略编辑工作台新增“引用悬停联动 K 线指标线”能力。鼠标悬停条件引用值时，图表对应指标线执行一次“闪烁 + 线宽脉冲”；有引用时使用较完整节奏，无引用时仅短促闪烁，用于快速定位并降低持续动画带来的性能抖动。
