...
- alias_name
- description
- state (draft/ready/running/paused/archived)
...
- INSERT `user_strategy` (state=draft, visibility=private)
...
- INSERT `user_strategy` (source_type='share_code', pinned_version_id 复用源)
